...
exports.email = exports.mail_message = void 0;
const MailerModel_1 = require("../interfaces/MailerModel");
function mail_message() {
    return new MailerModel_1.MailMessage({
        to: 'enzonav@yahoo.it',
...
exports.mail_message = mail_message;
const email = new MailerModel_1.MailMessage({
    to: 'enzonav@yahoo.it',
    from: 'double.facessss@gmail.com',
    subject: 'Test Message',
